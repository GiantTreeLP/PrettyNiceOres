...
public final class Constants {
    ...
    public static final String CATEGORY_ENABLED_BLOCKS = "enabled_blocks";
    ...
    static final String CONFIG_S_CATEGORY = "config.%s.category";
    static final String GUI_FACTORY = "gtlp.prettyniceores.gui.NiceGuiFactory";
